        ...
        friends.map((friendDetails) => {
          return (
            <div
              ...
              className="bg-white p-4 my-4 border-solid shadow-lg border-black-600 rounded-lg flex flex-row items-center"
            >
              <img
              ...
              <div className="flex gap-4 ml-auto">
                ...
                >
                  <BsTrash2Fill className="text-2xl" /> Remove friend
                </button>
              </div>
            </div>
          );
